...
- Cursando ADS (Faculdade Impacta)
- Interesse em **Quality Assurance**, testes de software e desenvolvimento
- Aprendendo Python, Java, HTML e boas práticas de versionamento com Git
...
|---------|-----------|-------------|
| [impacta](https://github.com/gusjmo/impacta) | Sistema web de agendamentos e CRM | HTML, Python |
